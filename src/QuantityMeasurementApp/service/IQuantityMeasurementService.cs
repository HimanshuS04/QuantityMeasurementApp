namespace QuantityMeasurementApp
{
    public interface IQuantityMeasurementService
    {
        ...
        // Temperature (UC14)
        bool AreTemperatureQuantitiesEqual(double firstValue, TemperatureUnit firstUnit, double secondValue, TemperatureUnit secondUnit);
        double ConvertTemperature(double value, TemperatureUnit sourceUnit, TemperatureUnit targetUnit);
    }
}