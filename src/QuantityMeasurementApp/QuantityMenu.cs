    ...
    public class QuantityMenu
    {
        ...
        public void ShowMainMenu()
        {
            ...
            while (!shouldExit)
            {
                ...
                Console.WriteLine("4. Convert between length units (UC5)");
                Console.WriteLine("5. Add two length quantities (UC6)");
        ...
        private void ExecuteUnitAddition()
        {
            ...
            // Result in unit of the first operand (UC6 requirement)
